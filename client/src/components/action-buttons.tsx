...
export default function ActionButtons({ onReject, onLike, onSuperLike, disabled = false }: ActionButtonsProps) {
  return (
    <div className="flex items-center space-x-4">
      ...
      >
        <div className="w-16 h-12 bg-white/35 backdrop-blur-2xl rounded-lg flex items-center justify-center
                        shadow-[0_12px_24px_rgba(0,0,0,0.4),0_8px_16px_rgba(0,0,0,0.2),inset_0_2px_4px_rgba(255,255,255,0.3)]
                        border border-white/30 
                        group-active:bg-white/45 group-active:shadow-[0_6px_12px_rgba(0,0,0,0.5),inset_0_3px_6px_rgba(0,0,0,0.2)]
      ...
      >
        <div className="w-20 h-12 bg-amber-400/40 backdrop-blur-2xl rounded-lg flex items-center justify-center
                        ...
                        group-active:bg-amber-400/50 group-active:shadow-[0_8px_16px_rgba(245,158,11,0.5),inset_0_4px_8px_rgba(0,0,0,0.2)]
                        group-active:transform group-active:translate-y-1
                        transition-all duration-200 hover:bg-amber-400/45">
      ...
      >
        <div className="w-16 h-12 bg-blue-500/40 backdrop-blur-2xl rounded-lg flex items-center justify-center
                        ...
                        group-active:bg-blue-500/50 group-active:shadow-[0_6px_12px_rgba(29,78,216,0.5),inset_0_3px_6px_rgba(0,0,0,0.2)]
                        group-active:transform group-active:translate-y-1
                        transition-all duration-200 hover:bg-blue-500/45">
